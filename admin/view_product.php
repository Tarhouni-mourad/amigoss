...
<head>
    ...
    <title>Amigos - View Product</title>
    <!-- Bootstrap CSS -->
...
<?php require_once('../config.php');
 ...
 ?>
    <tr>
        ...
        <td>DNR. <?php echo $res['product_price'];?></td>
        <td>
    <?php $file_array = explode(', ', $res['product_image']); ?>
    <div class="owl-carousel owl-theme" style="width: 100px;">
    <?php for ($j=0; $j < count($file_array); $j++) { ?>
     <div class="item"> 
...
<option value="<?php echo $res['category_id'];?>"><?php echo $res['category_name'];?></option>
    ...
    <input id="inputProductPrice" type="text" name="product_price" required="" placeholder="Enter product price" autocomplete="off">
                                        </div>
