...
<tr>
    ...
    <td>
        <img src="http://localhost/onlinecakeshop/uploads/<?php echo $res['product_image']; ?>" alt="<?php echo $res['product_name']; ?>" style="width: 70px; height: 70px;">
        <input type="hidden" name="hidden_product_image[]" value="<?php echo $res['product_image']; ?>">
    </td>
    
    
                                        <td><?php echo $res['product_name']; ?><input type="hidden" name="hidden_product_name[]" value="<?php echo $res['product_name']; ?>"></td>
                                        <td>DNR. <?php echo $res['product_price']; ?><input type="hidden" name="hidden_product_price[]" value="<?php echo $res['product_price']; ?>"></td>
                                        <td><input class="form-control" type="number" min="1" max=" " step="1" value="1" name="product_quantity[]" onchange="prodTotal(this)"></td>
                                        <td><span>DNR. <?php echo $res['product_price'] * 1; ?></span><input type="hidden" name="hidden_product_total[]" value="<?php echo $res['product_price']; ?>"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" id="total_amount"><span>DNR. <?php if ($printCount == 0) {
                                                                          echo 0;
                                                                      } else {
                                                                          echo $total_amount;
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        Copyright © 2018 Concept. All rights reserved. Dashboard by <a href="https://Tarhouni-Mouradcom/wp/">Tarhouni-Mourad.</a>.
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    ...
    <script>
        ...
        function prodTotal(quantity) {
            ...
            $(quantity).parent().next().find('span').html("DNR. " + total);
            var total_amount = 0;
            $('input[name="hidden_product_total[]"]').each(function() {
                total_amount += parseInt($(this).val());
            });
            $('#total_amount').find('span').html("DNR. " + total_amount);
